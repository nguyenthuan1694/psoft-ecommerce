...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form id="RangeValidation" class="form-horizontal" enctype="multipart/form-data" novalidate action="{{ route('news.store') }}" method="post">
                    {{ csrf_field() }}
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-10">
                                    <div class="tinymce-wrap">
                                        <textarea class="form-control" rows="3" name="short_description" placeholder="Write some description about the category">
                                        </textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div class="tinymce-wrap">
                                        <textarea class="tinymce" rows="3" name="long_description" placeholder="Write some description about the category">
                                        </textarea>
                                    </div>
                                </div>
                            </div>
